...
const RegisterForm = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values,{resetForm}) => {
      try {
       await axios.post(
          `${process.env.REACT_APP_BACKEND_URL}/user/register-user`,
          {
  ...
  return (
    ...
    >
      ...
      <Button variant="contained" sx={{margin:"0px auto", width:"70px", height:"70px", borderRadius:"50%"}}>
<FaLock/>
      </Button>
      </Box>
 
      <form sx={{ width: "100%", marginBottom:"20px" }} onSubmit={formik.handleSubmit}>
        <TextField
